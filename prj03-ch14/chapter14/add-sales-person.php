...
$insertQuery = "INSERT INTO personnel (empID, firstName, lastName, jobTitle, hourlyWage)
VALUES ('$empID', '$firstName', '$lastName', 'sales', 14.25)";

$insertResult = mysqli_query($connect, $insertQuery);

if (!$insertResult) 
{
	die("Could not successfully run query ($insertQuery) from $db: " .	
